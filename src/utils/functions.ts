...
//     if(value.match(numbers).length < 11) return {correct: false, error: 'Minimum phone number length 11 characters' }
...
//         const numberSplice = clearPhone.replace(/\D/g, '').match(/(\d{1})(\d{3})(\d{3})(\d{2})(\d{2})/)
//         return`+${numberSplice[1]} (${numberSplice[2]}) ${numberSplice[3]}-${numberSplice[4]}-${numberSplice[5]}`
//     }
//     if (clearPhone.length === 12) {
//         const numberSplice = clearPhone.replace(/\D/g, '').match(/(\d{2})(\d{3})(\d{3})(\d{2})(\d{2})/)
//         return`+${numberSplice[1]} (${numberSplice[2]}) ${numberSplice[3]}-${numberSplice[4]}-${numberSplice[5]}`
//     }
//     if (clearPhone.length === 13) {
//         const numberSplice = clearPhone.replace(/\D/g, '').match(/(\d{3})(\d{3})(\d{3})(\d{2})(\d{2})/)
//         return`+${numberSplice[1]} (${numberSplice[2]}) ${numberSplice[3]}-${numberSplice[4]}-${numberSplice[5]}`
//     }
//     if (clearPhone.length === 14) {
//         const numberSplice = clearPhone.replace(/\D/g, '').match(/(\d{4})(\d{3})(\d{3})(\d{2})(\d{2})/)
//         return`+${numberSplice[1]} (${numberSplice[2]}) ${numberSplice[3]}-${numberSplice[4]}-${numberSplice[5]}`
//     }
// }
